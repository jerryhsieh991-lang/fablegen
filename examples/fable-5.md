...
_Lean prompts, strong heuristics — Fable 5 degrades on bloat._

> Give the full spec up front in one turn and run at xhigh effort. Keep this prompt lean — over-prescription degrades Fable 5.
...
- State the goal up front and keep instructions minimal-but-strong.
- Lean on memory and context, not a wall of rules.
