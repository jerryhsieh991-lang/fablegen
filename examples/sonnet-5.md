# Master Prompt · Claude Sonnet 5
_Precise instruction-follower — give explicit steps + a stop condition._

> Give explicit, itemized steps and a numeric effort/step budget with a concrete stop condition. Sonnet 5 follows precise instructions better than it infers, so spell out the desired behavior.
...
- Give trigger → action example pairs, not just abstract rules.
- State a numeric step/effort budget and an explicit stop condition for autonomous work.
